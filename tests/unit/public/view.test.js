...
describe('#View - test suite for presentation layer', () => {
 ...
 test('#changeCommandBtnsVisibility - given hide=true it should add unassinged class and reset onclick', () => {
  const view = new View()
 ...
 test('#changeCommandBtnsVisibility - given hide=false it should remove unassinged class and reset onclick', () => {
  const view = new View()
  const btn = makeBtnElement()
  jest.spyOn(
   document,
